                    ...
                    <div style="border: 2px solid #11C2EE;width: 600px;height: 400px;margin: 6px 2px" id="jihua">
                        ...
                        <div class="modal-body">
                            ...
                            <form class="form-horizontal" id="forecastDataForm" action="#" method="post">
                                ...
                                <div class="form-group">
                                    <label for="planNum" class="col-sm-4 control-label">计划召开桌数：</label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" name="planNum" id="planNum" placeholder="请输入计划召开数量"><br>
                                    </div>
                                </div>
...
<script>
    function forecast() {
        ...
        $.ajax({
            url:"${pageContext.request.contextPath}/data/predictionData",
            type:"post",
            data:data,
            dataType:"json",
            contentType:false,
