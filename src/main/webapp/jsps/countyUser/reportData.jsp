            ...
            <div class="col-sm-12">
                <div>
                    <ul class="nav nav-tabs" id="myTabs">
                        <li class="active"><a href="#reportMessage" aria-controls="reportMessage" data-toggle="tab" id="reportMes"></a>
                        </li>
                        <li><a href="#uploadPic" aria-controls="uploadPic" data-toggle="tab" id="upPic"></a></li>
                    </ul>
                            ...
                            <div class="modal-body">
                                ...
                                <form class="form-horizontal" id="reportDataForm" action="#" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                           <%-- <p class="form-control-static">${forecast.activeName}</p>--%>
                                            <input type="hidden" value="${param.activeName}">
                                        </div>
                                    </div>
                                    ...
                                    <input type="hidden" id="foreId" name="foreId">
                                </form>
...
<script>
    ...
    function report() {
        ...
        $.ajax({
            url:"${pageContext.request.contextPath}/countyUser/reportData",
            type:"post",
            data:data,
            dataType:"json",
            contentType:false,
            ...
            success:function (data) {
                if (data){
                    alert("success")
                    $("#uploadPic").show();
                    window.location.href="/jsps/countyUser/reportData.jsp?tab=uploadPic";
